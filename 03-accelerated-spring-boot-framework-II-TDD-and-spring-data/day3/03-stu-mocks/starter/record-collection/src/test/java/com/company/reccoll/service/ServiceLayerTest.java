...
public class ServiceLayerTest {
    ...
    @Test
    public void shouldFindAlbumViewModelById() {
        ...
        expectedResult.setListPrice(new BigDecimal("14.99"));  // Always construct big decimals as strings
        expectedResult.setReleaseDate(LocalDate.of(1999, 05, 15));
        expectedResult.setTracks(tList);

        AlbumViewModel actualResult = service.findAlbum(1);
    ...
    @Test
    public void saveFindAlbum() { fail("Not implemented"); }

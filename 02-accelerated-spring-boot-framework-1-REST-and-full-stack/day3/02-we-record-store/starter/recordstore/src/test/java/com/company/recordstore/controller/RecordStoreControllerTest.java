...
public class RecordStoreControllerTest {
    ...
    @Test
    public void shouldReturn422StatusCodeForInvalidRequestBody() throws Exception {
        Record inputRecord = new Record("The Beach Boys", "Pet Sounds", "2022", 2);

        String jsonInput = mapper.writeValueAsString(inputRecord);
    ...
    @Test
    public void shouldReturn422StatusCodeForMisMatchingIDS() throws Exception {
        Record inputRecord = new Record("The Beach Boys", "Pet Sounds", "2022", 2);
